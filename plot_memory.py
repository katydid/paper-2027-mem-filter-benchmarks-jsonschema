...
IMPL_RENAMES = {
    ...
    'corvus': 'Corvus',
    'go-google': 'google (Go)',
    'go-json-schema-spec': 'json-schema-spec (Go)',
    'go-kaptinlin': 'kaptinlin (Go)',
    'go-katydid-auto': 'katydid-auto (Go)',
    'go-katydid-mem': 'katydid-mem (Go)',
    'go-santhosh-tekuri': 'santhosh-tekuri (Go)',
    'jsu-c': 'JSU (C)',
    'jsu-java': 'JSU (Java)',
    'jsu-js': 'JSU (JS)',
    'jsu-pl': 'JSU (Perl)',

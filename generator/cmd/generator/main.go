...
var generators = []schemaGenerator{
	...
	{
		name:   "zschema_basic-rmUniqueItems-mixed",
		gen:    basic.ProductSetrmUniqueItems(),
		schema: basic.SchemaBasicrmUniqueItems,
		num:    200,
	},
	{
		name:      "zschema_basic-rmUniqueItems-valid",
		gen:       basic.ProductSetrmUniqueItems(),
		schema:    basic.SchemaBasicrmUniqueItems,
		validOnly: true,
		num:       200,
	...
	{
		name:   "zschema_advanced-rmUniqueItems-mixed",
		gen:    advanced.AdvancedrmUniqueItems(),
		schema: advanced.SchemaAdvancedrmUniqueItems,
	},
	{
		name:      "zschema_advanced-rmUniqueItems-valid",
		gen:       advanced.AdvancedrmUniqueItems(),
		schema:    advanced.SchemaAdvancedrmUniqueItems,
		validOnly: true,
	},
